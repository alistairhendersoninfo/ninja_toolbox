...
run() {
    log_info "Nmap-Unleashed — Auto Scan"
    log_info "Runs an automated scan using nmap-unleashed default profile."
    log_info "Combines host discovery, port scanning, and service detection."
    echo ""
    ...
    echo ""
    log_success "Auto scan complete."
}
