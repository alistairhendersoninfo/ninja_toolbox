...
run() {
    log_info "Nmap — Quick Scan"
    log_info "Scans the top 100 most common ports (-F = fast mode)."
    log_info "Much faster than a full port scan while catching most services."
    echo ""
