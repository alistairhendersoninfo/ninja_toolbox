...
services:
  polaris:
    ...
    environment:
      ...
      - POLARIS_PERSISTENCE_ECLIPSELINK_URL=jdbc:h2:file:/app/data/polaris;MODE=PostgreSQL
    networks:
      - polaris-net
...
UNIT
    ...
    log_success "Apache Polaris installed"
    log_info "Polaris API: http://localhost:8181"
    mark_installed true
}
...
uninstall() {
    ...
    log_success "Apache Polaris uninstalled"
